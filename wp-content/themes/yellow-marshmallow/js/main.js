jQuery(document).ready(function($) {
   'use strict';
        ...
        jQuery(window).load(function() {
            ...
            jQuery('.text-slider').removeClass('preload');
        });
        ...
        jQuery(document).ready(function($) {
            ...
            /*
            $zopim(function(){
                $zopim.livechat.setOnConnected(zopimStuff);

                function zopimStuff(callback){
                    $('.zopim').addClass('zopim-new');
                }

            });
            */

            $("ul.service-list-main li").click(function() {
                $("ul.service-list-main li span:visible").slideUp(300);
            ...
            $('.ubermenu-responsive-toggle').on('touchstart click', function () {
                if($('#header').hasClass('nav-toggle')){
                    $('#header').removeClass('nav-toggle');
                }else{
                    $('#header').addClass('nav-toggle');
                }
            });
            ...
            // SCROLL TO
            $('#main-menu-top a[href^="#"],#top-header nav a[href^="#"],ul.slicknav_nav li a[href^="#"]').click(function(event){
                ...
                $('#top-header nav a').removeClass('active').css('border-bottom-color', 'none');
            ...
            // PARALLAX EFFECT
            $('.parallax2').height($(this).parent().outerHeight());
            ...
            function splitColumns() {
                var winWidth = $('.portfolio-list').width(),
                    columnNumb = 1;
            ...
            $('.vertical-center').each(function(){
                ...
                var offsetTop = (containerHeight - $(this).find('.vertical-center').height())/2;
            ...
            $('.center-center').each(function(){
                var containerHeight = $(this).height();
                var containerWidth = $(this).width();
                var offsetTop = (containerHeight - $(this).find('.center-center').height())/2;
                var offsetLeft = (containerWidth - $(this).find('.center-center').width())/2;

                $(this).css({'margin-top': -offsetTop, 'margin-left': -offsetLeft});
            });
            ...
            $(document).ready(function(){
                ...
                $(window).scroll(function () {
                    ...
                    $('.tp-parallax-container').css({'opacity': ((fullHeight/2 - scroll) / 500) + 0.5});
                      if ( $(this).scrollTop() > 1 ) {
                        $('#header').addClass('sticky');
            ...
            //$(".blog-header-wrapper nav a").prop("href", "http://frederick.tmweb.ru");
